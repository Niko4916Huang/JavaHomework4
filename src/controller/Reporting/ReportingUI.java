...
public class ReportingUI extends JFrame {
	...
	public ReportingUI() {
		...
		panel.setBounds(18, 6, 756, 32);
		contentPane.add(panel);
		panel.setLayout(null);
		
		JLabel lblNewLabel = new JLabel("報 表 查 詢");
		lblNewLabel.setFont(new Font("Lucida Grande", Font.PLAIN, 20));
		lblNewLabel.setForeground(new Color(12, 35, 255));		// font - blue
		lblNewLabel.setBounds(331, 3, 118, 26);
	...
	// 小時鐘介面
        ...
        clockPanel.setBounds(660, 3, 90, 32);
     ...
     // 啟動時鐘更新
		...
		panel_2.setBounds(125, 50, 655, 311);
...
/*******************************************************************/
		...
		String Ordering = "==> 依 [商品] 編號排列";
		String show = "";
		if (received.getInqty() == 0)		// Inqty == 0, order by itemno
		{									// Indate -> IndateFrom;  Itemno -> IndateTo
			show = new ReceivedDaoImpl().orderbyItemno(received.getIndate(), received.getItemno());
		}
		else
		{		// order by factoryno
			Ordering = "==> 依 [廠商] 編號排列";
			show = new ReceivedDaoImpl().orderbyFactoryno(received.getIndate(), received.getItemno());
		}
		...
		btnNewButton.setBounds(174, 273, 117, 29);
		...
		btnPrint.setBounds(350, 271, 117, 29);
