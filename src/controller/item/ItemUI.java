...
import controller.factory.AddFactoryUI;
...
public class ItemUI extends JFrame {
	...
	public ItemUI() {
		...
		JLabel lblNewLabel = new JLabel("商品基本資料作業");
...
/***************************************************************/
		...
		lblNewLabel_2.setBounds(101, 93, 75, 16);
		panel_2.add(lblNewLabel_2);
		
		
		t_itemno = new JTextField();
		t_itemno.setBounds(188, 90, 190, 21);
		panel_2.add(t_itemno);
		t_itemno.setColumns(10);
		
		JButton bntQuery = new JButton("查  詢");
		bntQuery.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (!t_itemno.getText().equals(""))
				{
					String Itemno=t_itemno.getText();
					
				//	System.out.println("current itemno: "+Itemno);
